"""
Usage:
        bvcctl http [options] get <resource>
        bvcctl http [options] delete <resource>
        bvcctl http [options] post <resource> ([--payload <payload>] | [--file <file>])
        bvcctl http [options] put <resource> ([--payload <payload>] | [--file <file>])
