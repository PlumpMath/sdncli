...
def netconf_mount_mlx(name, address, port, user, password):
    ...
    <module xmlns="urn:opendaylight:params:xml:ns:yang:controller:config">
      ...
      <password xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">{password}</password>
      <yang-module-capabilities xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">
      <capability xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">http://brocade.com/ns/netconf/config/netiron-config?module=netiron-config</capability>
      <capability xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">http://brocade.com/ns/netconf/config/common-defs?module=common-defs</capability>
      <capability xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">http://brocade.com/ns/netconf/config/vlan-config?module=vlan-config</capability>
      <capability xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">http://brocade.com/ns/netconf/config/interface-config?module=interface-config</capability>
      <capability xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">http://brocade.com/ns/netconf/config/mpls-config?module=mpls-config</capability>
      <capability xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">urn:ietf:params:xml:ns:yang:ietf-yang-types?module=ietf-yang-types&amp;revision=2010-09-24</capability>
      </yang-module-capabilities>
        <tcp-only xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">false</tcp-only>
      <event-executor xmlns="urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf">
